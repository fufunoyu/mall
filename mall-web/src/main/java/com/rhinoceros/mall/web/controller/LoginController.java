...
public class LoginController {
    ...
    public String resetPassword(Model model, @RequestParam(ConstantValue.RESET_PASSWORD_PARAM) String secret) {
        model.addAttribute(ConstantValue.RESET_PASSWORD_PARAM, secret);
